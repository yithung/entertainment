<?php include('film_features_back.php'); ?>
<?php
...
<?php 
	if (isset($_GET['edit'])) {
		$filmFeaturesID = $_GET['edit'];
		$update = true;
		$record = mysqli_query($db, "SELECT * FROM film_features WHERE film_features_id=$filmFeaturesID");
...
<?php $results = mysqli_query($db, "SELECT * FROM film_features"); ?>
			...
			<tbody>
				...
				<?php while ($row = mysqli_fetch_array($results)) { ?>
					<tr>
						...
						<td>
							<a href="film_features_front.php?edit=<?php echo $row['film_features_id'];?>" class="edit_btn" >Edit</a>
						</td>
						<td>
							<a href="film_features_back.php?del=<?php echo $row['film_features_id'];?>" class="dlt_btn">Delete</a>
						</td>
					</tr>
				<?php } ?>
			</tbody>
	...
	<div>
		...
		<form method="post" action="film_features_back.php" style="background: #e8fffd;">
			<div>
				<?php if ($update == true): ?>
					<h3>Update Data</h3>
				<?php else: ?>
			...
			<div class="input-group">
				<label>Film ID</label>
				<input type="number" name="film_id" value="<?php echo $filmID; ?>" required>
			</div>

			<div class="input-group">
				<label>Feature ID</label>
				<input type="number" name="feature_id" value="<?php echo $featureID; ?>" required>
			</div>
