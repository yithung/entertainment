...
<?php 
	if (isset($_GET['edit'])) {
		$paymentID = $_GET['edit'];
		$update = true;
		$record = mysqli_query($db, "SELECT * FROM payment WHERE payment_id=$paymentID");
...
<?php $results = mysqli_query($db, "SELECT * FROM payment"); ?>
			...
			<tbody>
				...
				<?php while ($row = mysqli_fetch_array($results)) { ?>
					<tr>
						...
						<td>
							<a href="payment_front.php?edit=<?php echo $row['payment_id']; ?>" class="edit_btn" >Edit</a>
						</td>
						<td>
							<a href="payment_back.php?del=<?php echo $row['payment_id']; ?>" class="dlt_btn">Delete</a>
						</td>
					</tr>
				<?php } ?>
			</tbody>
	...
	<div>
		...
		<form method="post" action="payment_back.php" style="background: #f2fff4;">
			<div>
				<?php if ($update == true): ?>
					<h3>Update Data</h3>
				<?php else: ?>
			...
			<div class="input-group">
				...
				<input type="number" name="payment_id" value="<?php echo $paymentID; ?>">
			</div>
			...
			<div class="input-group">
				...
				<input type="datetime-local" name="payment_date" value="<?php echo $payDate; ?>" required>
			</div>
