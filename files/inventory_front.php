<?php  include('inventory_back.php'); ?>
<?php
...
<?php 
	if (isset($_GET['edit'])) {
		...
		$update = true;
		$record = mysqli_query($db, "SELECT * FROM inventory WHERE inventory_id=$inventoryID");
...
<?php $results = mysqli_query($db, "SELECT * FROM inventory"); ?>
			...
			<tbody>
				...
				<?php while ($row = mysqli_fetch_array($results)) { ?>
					<tr>
						...
						<td>
							<a href="inventory_front.php?edit=<?php echo $row['inventory_id']; ?>" class="edit_btn" >Edit</a>
						</td>
						<td>
							<a href="inventory_back.php?del=<?php echo $row['inventory_id']; ?>" class="dlt_btn">Delete</a>
						</td>
					</tr>
				<?php } ?>
			</tbody>
	...
	<div>
		...
		<form method="post" action="inventory_back.php" style="background: #cfdaff;">
			<div>
				<?php if ($update == true): ?>
					<h3>Update Data</h3>
				<?php else: ?>
			...
			<div class="input-group">
				...
				<input type="number" name="inventory_id" value="<?php echo $inventoryID; ?>">
			</div>
