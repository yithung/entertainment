...
<?php 
	if (isset($_GET['edit'])) {
		$addressID = $_GET['edit'];
		$update = true;
		$record = mysqli_query($db, "SELECT * FROM address WHERE address_id=$addressID");
...
<?php $results = mysqli_query($db, "SELECT * FROM address"); ?>
			...
			<tbody>
				...
				<?php while ($row = mysqli_fetch_array($results)) { ?>
					<tr>
						...
						<td>
							<a href="address_front.php?edit=<?php echo $row['address_id']; ?>" class="edit_btn" >Edit</a>
						</td>
						<td>
							<a href="address_back.php?del=<?php echo $row['address_id']; ?>" class="dlt_btn">Delete</a>
						</td>
					</tr>
				<?php } ?>
			</tbody>
	...
	<div>
		...
		<form method="post" action="address_back.php" style="background: #fff8f2;">
			<div>
				<?php if ($update == true): ?>
					<h3>Update Data</h3>
				<?php else: ?>
			...
			<div class="input-group">
				...
				<input type="number" name="address_id" value="<?php echo $addressID; ?>">
			</div>
			...
			<div class="input-group">
				<label>City ID</label>
				<input type="number" name="city_id" value="<?php echo $cityID; ?>" required>
			</div>

			<div class="input-group">
				<label>Postal Code</label>
				<input type="text" name="postal_code" value="<?php echo $postcode; ?>">
			</div>
